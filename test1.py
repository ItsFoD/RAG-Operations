...
# --- Check if input is about date or event ---
...
- If action is "create_event", include: summary, description, start_time (YYYY-MM-DDTHH:MM:SS), end_time, timezone, attendee_email
